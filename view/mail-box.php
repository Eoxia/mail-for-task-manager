<div id="mail_<?php echo esc_html( $i ); ?>">
  ...
  <p><label for="client_mail">Client :</label><input id="client_mail" type="text" value='<?php echo esc_html( $client_name . ' ( ' . $client_mail . ' )' ); ?>' disabled="disabled" /></p>
  <p>Intitulé : <?php echo esc_html( imap_utf8( $mail_title ) ); ?></p>
  <p><label for="mail_content">Demande :</label><textarea id="mail_content" disabled="disabled" ><?php echo esc_html( imap_utf8( $body_text ) ); ?></textarea></p>
<?php if ( $count ) { ?>
...
if ( ! empty( $mail_test['attachment'] ) ) {?>
	...
	<p> Cette e-mail contient des attachements</p>
	<?php } ?>
