...
/**
 * Supprime la div si le bouton 'Cacher l'affichage' de la div en question est cliqué
 *
 * @param  {int} idDiv            l'id de la div
 * @return {void}       rien
 */
function deleteDiv( idDiv ) {
	var divId = idDiv;
	jQuery( '#mail_' + divId ).remove(); // // Je supprime le message qui vient dêtre traité de l'interface.
}
